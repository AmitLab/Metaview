...
wellPanel(titlePanel("Analysis Of Single Cell RNAseq Data with MetaCell package",windowTitle = "ScRNAseq Analysis with MetaCell"),
          fluidPage(
            navlistPanel(widths = c(2, 10),
              ...
              ,tabPanel("MetaCell constructions - Rmarkdown",column(12,uiOutput("lung_metacell_model"))),
              tabPanel("Ligand-Receptor analysis - Rmarkdown",column(12,uiOutput("lung_lig_rec")))
              )
            )
          )
